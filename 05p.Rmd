...
In this portfolio, I aimed to be familair with regression, especially when the DV is non-normal.
Especially, this project will investigate when the DV is binomail. (which menas that DV is just 0 or 1)
...
If the outcome variable is binary, using the logistic link function seems to be recomanded.
